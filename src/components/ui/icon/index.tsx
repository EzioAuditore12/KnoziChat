...
const Icon = React.forwardRef<React.ComponentRef<typeof UIIcon>, IIConProps>(function Icon(
  ...
  if (typeof size === 'number') {
    return (
      <StyledUIIcon ref={ref} {...props} className={iconStyle({ class: className })} size={size} />
    );
  } else if ((props.height !== undefined || props.width !== undefined) && size === undefined) {
    return <StyledUIIcon ref={ref} {...props} className={iconStyle({ class: className })} />;
  }
  return <StyledUIIcon ref={ref} {...props} className={iconStyle({ size, class: className })} />;
});
